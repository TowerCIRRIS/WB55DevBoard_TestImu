#ifndef _TEAMAT_GFX_H
#define _TEAMAT_GFX_H

#include "../GFX_Library/gfxfont.h"
...
public:
  TeamAT_GFX(int16_t w, int16_t h); // Constructor
...
//#if ARDUINO >= 100
  ...
  size_t write(const char* c, uint16_t len = 0);
//#else
